...
def main():
    ...
    success=[]
    results=[]
    log_file = open('logr.txt', 'w')
    rows=[]
    tot=0
    stop_words_set = criteria.get_stopwords()
    print('Start attacking!')
    with open("results/results-cnn-imdb.csv","r") as csvfile:
    ...
    for idx, (text, true_label) in enumerate(data):
        ...
        if args.perturb_ratio > 0.:
            ...
            orig_label = attack(text, true_label, predictor, stop_words_set,
